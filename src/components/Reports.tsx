        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <div className="flex justify-between items-center mb-6">
            ...
            <button
              ...
              className="flex items-center px-4 py-2 bg-coop-600 text-white rounded-lg hover:bg-coop-700 transition-colors"
            >
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {paginatedDepartments.map(([dept, data]) => (
                  <tr key={dept}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      {data.vouchers > 0 ? Math.round((data.drinks / (data.vouchers * 4)) * 100) : 0}%
                    </td>
                  </tr>
                ))}
              </tbody>
          ...
          <Pagination
            ...
            totalItems={departmentEntries.length}
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <button
            ...
            className="flex items-center justify-center px-4 py-3 bg-coop-600 text-white rounded-lg hover:bg-coop-700 transition-colors"
          >
          ...
          <button
            ...
            className="flex items-center justify-center px-4 py-3 bg-coop-blue-600 text-white rounded-lg hover:bg-coop-blue-700 transition-colors"
          >
            <Download className="h-5 w-5 mr-2" />
