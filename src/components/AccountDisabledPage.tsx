...
import {AlertTriangle, LogOut, Mail, Phone, Shield} from 'lucide-react';
        ...
        <PublicPage children={
            <>
                ...
                <div className="bg-white rounded-xl shadow-2xl p-8 text-center">
                    {/* Icon */}
                    <div
                        className="w-20 h-20 bg-coop-red-100 rounded-full flex items-center justify-center mx-auto mb-6">
                    ...
                    <p className="text-gray-600 mb-6 leading-relaxed">
                        Your account has been disabled by an administrator. You no longer have access to the Party
                        Management System.
                    </p>
